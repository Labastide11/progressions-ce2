/* Progressions CE2 V35.62 — Banque annuelle unique des dictées */
(function(){
'use strict';
...
6:{support:'Le voyage — 5 « La Grande Muraille »',theme:'La Grande Muraille',words:'une frontière, une invasion, le nord, une structure, l’homme, une longueur, une tour de guet, important, contre, jamais',priority:'frontière, structure, longueur, tour de guet, jamais',orthographeCible:'M devant m, b, p ; mémorisation de mots fréquents et invariables.',motsCibles:'une frontière, une invasion, le nord, une structure, l’homme, une longueur, une tour de guet, important, contre, jamais',grammaireCible:'Consolider verbe, infinitif, sujet et pronom.',exempleGrammaire:'Repérer sujet et verbe dans une phrase sur la Grande Muraille.',reactivation:'Réutiliser au moins deux mots déjà mémorisés.',reactivationWords:'2 mots déjà appris, choisis parmi ceux encore hésitants.',flashes:[['Mardi','La Grande Muraille marque une ancienne frontière de la Chine.'],['Jeudi','Des tours de guet se dressent sur toute sa longueur.'],['Vendredi','Cette importante structure a été construite contre les invasions venues du nord.']],final:'La Grande Muraille a été construite pour défendre la frontière nord de la Chine. Des tours de guet se trouvent sur toute sa longueur.',note:'Série annoncée à l’avance : ces 10 mots servent au bilan de mots appris de P1.'},
...
const annualFrenchPlans={
    p2:[
      ...
      {support:'Le voyage — 8 « L’île de Pâques »',flash:['L’île de Pâques se trouve dans l’océan Pacifique.','Elle est célèbre pour ses statues impressionnantes appelées les Moaïs.','Ces statues ont été taillées dans la roche d’un volcan.'],final:'L’île de Pâques, appelée aussi Rapa Nui, se trouve dans l’océan Pacifique. Elle est célèbre pour ses immenses statues, les Moaïs, taillées dans la roche volcanique.',words:['tailler','une paroi','un cratère','un volcan','l’intérieur','aligner','la côte','la mer','le long','un dos'],priority:['paroi','cratère','volcan','intérieur','côte'],vocab:['navigateur : famille naviguer','volcan : champ lexical','impressionnant : synonymes et intensité'],note:'Série annoncée à l’avance : ces 10 mots servent au bilan de mots appris de P2.'}
    ],
    p3:[
      ...
      {support:'Le voyage — 14 « L’Opéra de Sydney »',flash:['L’Opéra de Sydney accueille de nombreux spectacles.','On y trouve des théâtres, des studios de répétition et de grands halls.','Les visiteurs peuvent aussi entrer dans des magasins de souvenirs et des restaurants.'],final:'L’Opéra de Sydney est l’un des bâtiments les plus célèbres d’Australie. Il accueille chaque année de nombreux spectacles et abrite plusieurs salles de théâtre.',words:['accueillir','un magasin','un souvenir','un hall','une répétition','un studio','un spectacle','un théâtre','un coquillage','un restaurant'],priority:['accueillir','souvenir','répétition','spectacle','théâtre'],vocab:['accueillir : famille accueil','spectacle : champ lexical','coquillage : sens et image de la forme'],note:'Série annoncée à l’avance : ces 10 mots servent au bilan de mots appris de P3.'}
    ],
    p4:[
      ...
      {support:'Le voyage — 19 « Angkor Vat »',flash:['Angkor Vat est un immense temple du Cambodge.','Le chantier a duré de nombreuses années et de grands bassins entourent le monument.','Des sculptures couvrent les parois et des moines vivaient dans le temple.'],final:'Angkor Vat est un grand temple du Cambodge. Construit comme tombeau royal, il est entouré de bassins et ses parois sont décorées de nombreuses sculptures.',words:['un tombeau','un chantier','un millier','un océan','un bassin','une paroi','un moine','le droit','un symbole','sculpter'],priority:['tombeau','chantier','bassin','paroi','sculpter'],vocab:['tombeau : sens et famille','chantier : contexte de construction','sculpter : famille sculpture, sculpteur'],note:'Série annoncée à l’avance : ces 10 mots servent au bilan de mots appris de P4.'}
    ],
    p5:[
...
const p1Dras={
  1:{phraseDepart:'La phrase écrite par l’élève dans « Trois mots pour ma rentrée ».',supprimer:'Ne pas introduire ce geste aujourd’hui sauf si un mot est clairement inutile.',deplacer:'Ne pas introduire ce geste aujourd’hui : le premier guidage porte sur Ajouter ou Remplacer.',remplacer:'Montrer comment remplacer un mot par un mot plus précis dans la phrase déjà écrite.',ajouter:'Montrer comment ajouter un mot ou une précision utile dans la phrase déjà écrite.',production:'Reprendre la phrase déjà produite, choisir un seul geste — Ajouter ou Remplacer — puis recopier la phrase améliorée avec majuscule et point.',motsAEmployer:'les 3 mots choisis dans la banque de rentrée ; conserver les mots réellement employés par l’élève'},
...
window.DICTEES_CE2={version:'35.62',p1,p2:annualFrenchPlans.p2,p3:annualFrenchPlans.p3,p4:annualFrenchPlans.p4,p5:annualFrenchPlans.p5};

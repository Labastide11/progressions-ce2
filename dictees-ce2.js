...
2:{theme:'Installer le rituel de dictée',words:'Premiers mots fréquents rencontrés en classe.',priority:'Sélection courte selon les observations de rentrée.',orthographeCible:'Mémoriser progressivement des mots fréquents et stabiliser les correspondances sons/graphies.',motsCibles:'À relever avec la classe dans les textes et activités de la semaine.',grammaireCible:'Reconnaître une phrase ; phrase affirmative et phrase négative.',exempleGrammaire:'« Le chat dort. » / « Le chat ne dort pas. »',reactivation:'Réutiliser les mots rencontrés pendant S1.',reactivationWords:'Mots réellement relevés lors du diagnostic de S1.',flashes:[],final:'',note:'Semaine d’installation : aucune liste artificielle.'},

    ...
    "days": [
      ...
      [
        ...
        [
            ...
            "9h–9h40",
            "Français — Cahier du jour",
            "📘 <strong>Cahier du jour</strong><br>🗓️ <strong>Date et titre :</strong> écrire la date et le titre de la séance.<br><br>💬 <strong>Rituel :</strong> Rituel Devinette — 3 nouvelles<br>1) <strong>Gomme</strong> : « Je suis petite, souvent blanche ou rose. Je fais disparaître les erreurs de crayon. Qui suis-je ? »<br>2) <strong>Cartable</strong> : « Je voyage chaque jour entre la maison et l’école. Je transporte cahiers, trousses et parfois le goûter. Qui suis-je ? »<br>3) <strong>Récréation</strong> : « Je coupe la matinée en deux. On sort dans la cour pour bouger, jouer et se détendre. Qui suis-je ? »<br><br>✍️ <strong>Dictée du jour :</strong> écrire la dictée.<br>✅ <strong>Correction :</strong> corriger juste en dessous.<br><br>🔎 <strong>Travail ciblé :</strong><br>• Grammaire : donner l’infinitif d’un verbe conjugué.<br>• Vocabulaire : comprendre un mot grâce au contexte",

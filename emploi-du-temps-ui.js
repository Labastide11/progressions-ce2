...
(() => {
  ...
  const periods = {
    rentree:{title:'Rentrée — Semaines 1 et 2 (sans CHAM)',note:'Emploi du temps de secours pour les deux premières semaines, tant que la date de démarrage de la CHAM n’est pas confirmée. Toute la classe reste réunie le mardi et le jeudi.',hours:['9 h 10','4 h 35','1 h','2 h 30','2 h 30','1 h','1 h 15'],minutes:[550,275,60,150,150,60,75],days:{},mode:'rentree'},
    p1:{title:'Période 1 — Grille refondue',note:'Fondamentaux regroupés le matin ; autres disciplines l’après-midi. Le mardi, 30 min de chants / expression corporelle suivent le quart d’heure de lecture. EPS : 45 min le lundi et 60 min maximum le vendredi.',hours:['8 h','4 h','50 min','1 h 45','3 h','45 min','3 h 40'],minutes:[480,240,50,105,180,45,220],days:{}},
    ...
    rentree1:{
      ...
      days:[
        ['Mardi 1er septembre 2026',[
          ...
          ['14h15–14h45','Éducation musicale — chants / expression corporelle','Échauffement vocal, chant collectif, jeux rythmiques et mouvements simples pour sentir et maintenir la pulsation.','MUS-ANN-01 · Chanter avec justesse et expressivité ; MUS-ANN-02 · Écouter et tenir sa place dans une production collective.','arts'],
          ['14h45–15h10','Production d’écrit — projet de CE2','Écrire : « Ce que j’aimerais apprendre en CE2 ».','Produire des phrases cohérentes et lisibles.','french'],
          ['15h10–15h30','Arts plastiques — porte-manteau','Créer son étiquette et commencer une production « palette de couleurs » pour le porte-manteau.','Expérimenter, produire et présenter une réalisation plastique.','arts'],
          ['15h30–15h45','Méthodologie — matériel et rangement','Découvrir les cahiers, classeurs, casiers, règles de rangement et premières responsabilités.','Utiliser les outils de la classe avec autonomie.','common'],
          ...
          ['16h30–17h','Temps d’échange et bilan de rentrée','Échanger sur la journée, les premières réussites, les questions et les besoins pour la suite.','OR-P1-03 · Respecter les règles d’un échange ; OR-P1-04 · Prendre la parole de façon compréhensible.','emc']
        ]],
  ...
  const p1LessonPlans={
    p1r1fridayeps:{week:1,title:'EPS — Coopérer dehors et respecter les règles de sécurité',duration:'1 h',domain:'EPS · jeux collectifs · coopération',support:'Cour / espace extérieur · sans ballon',objectives:['Se déplacer dans un espace défini sans se mettre en danger','Respecter un signal d’arrêt et une consigne','Coopérer avec plusieurs camarades','Respecter les règles d’un jeu collectif'],phases:[['10 min','1. Mise en route — « Statue ! »','Délimiter clairement l’espace. Les élèves marchent puis trottinent librement, changent de direction et de vitesse. Au signal « Statue ! », chacun s’immobilise immédiatement sans toucher un camarade. Exemple concret : annoncer successivement « marche », « trottine », « change de direction », puis « Statue ! ». Insister sur l’arrêt immédiat et la maîtrise de l’espace.'],['15 min','2. Jeu — Les maisons','Matérialiser plusieurs « maisons » avec des cerceaux, des plots ou des zones au sol. Les élèves se déplacent dans l’espace ; au signal, ils rejoignent une maison. Faire évoluer progressivement : 1 élève par maison, puis 2, puis 3 ou 4. Exemple concret : « Quand je frappe dans mes mains, trouvez une maison à trois sans pousser. » Faire verbaliser : partager l’espace, ne pas arracher une place, accepter de changer de groupe.'],['15 min','3. Jeu — Le chef d’équipe','Former des groupes de 4 ou 5. Un élève devient le chef et propose un déplacement que les autres reproduisent : marcher en zigzag, faire trois bonds, avancer à petits pas, contourner un plot, se déplacer latéralement. Changer de chef toutes les 2 à 3 minutes. Exemple concret : « Le chef fait trois bonds puis contourne le plot ; tout le groupe reproduit exactement le parcours. » Observer l’écoute, l’attente du tour et le respect du meneur.'],['15 min','4. Jeu — Chameaux–Chamois','Former deux équipes face à face de part et d’autre d’une ligne centrale : les Chameaux et les Chamois. Chaque élève a un adversaire en face. Si l’enseignant annonce « Chameaux ! », les Chameaux fuient vers leur ligne de refuge et les Chamois essaient de les toucher doucement ; si l’enseignant annonce « Chamois ! », les rôles s’inversent. Exemple concret : faire durer le début du mot — « Cha… cha… cha… Chamois ! » — pour obliger les élèves à écouter jusqu’au bout. Règles : toucher avec la main sans pousser, courir dans la zone prévue, s’arrêter à la ligne de refuge, revenir calmement au centre.'],['5 min','5. Retour au calme et bilan','Regrouper les élèves en cercle. Poser trois questions : « Quelle règle était importante pour jouer sans danger ? », « Dans quel jeu fallait-il particulièrement bien écouter ? », « Comment faire pour que tout le monde puisse jouer agréablement ? » Faire formuler une règle de sécurité et une règle de coopération.']],spiral:'Les règles observées aujourd’hui seront reprises dans les prochaines séances de jeux collectifs : écouter le signal, maîtriser ses déplacements, coopérer et accepter le résultat du jeu.',assessment:'Observation pratique : respect des signaux, écoute des consignes, maîtrise des déplacements, absence de poussées, coopération et capacité à accepter le résultat.',dys:'Consignes courtes données une par une ; démonstration avant chaque jeu ; repères visuels au sol ; placer les élèves ayant besoin d’aide près d’un camarade modèle.'},
  ...
  function renderP1Lesson(id,mode='teacher',step=0){
    ...
    const support=lesson.support||(lesson.hibou?('Maître Hibou — '+lesson.hibou.title):(lesson.week===1?'Charivari — série 1 « Le cheval et le fermier »':lesson.week===2?'Charivari — série 5 « Les métiers »':lesson.week===3?'Charivari — série 6 « Christophe et les nuages »':lesson.week===4?'Charivari — série 4 « La pluie »':'Réactivation des dictées Charivari de P1'));
    ...
    content.innerHTML=`<section class="lesson-view"><div class="detail-top"><div><span class="detail-zone">P1 · fiche de préparation enseignant</span><h2>${lesson.title}</h2><p>${lesson.domain} · ${lesson.duration}</p><p><strong>Support :</strong> ${support}</p></div><button class="detail-back" type="button" data-back-p1-week="${lesson.week}">← Retour à la semaine ${lesson.week}</button></div>${modeBar}
      ...
      ${String(lesson.domain||'').toUpperCase().startsWith('EPS')?'':renderP1DictationProgramming(lesson.week+2)}
      ${String(lesson.domain||'').toUpperCase().startsWith('EPS')?'':renderP1Corpus(lesson.week)}
  ...
  function altered(day,key,mode,period){
    ...
    if(mode==='rentree'&&day==='mardi') return [
      ...rows.slice(0,8),
      ['14h15–14h45','Chants / expression corporelle','Chant collectif, jeux rythmiques et mouvements simples en lien avec la pulsation','arts'],
      ['14h45–15h45','Arts et projets de rentrée','Classe entière : coopération, création, règles de vie','arts'],
      ['15h45–16h','Récréation','','break'],
      ['16h–16h45','Ateliers de rentrée','Classe entière : lecture, jeux mathématiques, découverte des outils','common'],
      ['16h45–17h','Bilan de journée','Parole aux élèves et préparation du lendemain','emc']
    ];
  ...
  function sessionDocumentsButton(meta){
    ...
    return `<div class="session-documents">${docs.map(doc=>{
      ...
      const isDrive=/^https:\/\/drive\.google\.com\//i.test(url);
      const isYoutube=/^https:\/\/(?:www\.)?(?:youtube\.com|youtu\.be)\//i.test(url);
      if(!isDrive&&!isYoutube)return '';
      const icon=isYoutube?'🎬':'📄';
      const where=isYoutube?'la vidéo':'le document';
      return `<a class="session-document-link" href="${url}" target="_blank" rel="noopener noreferrer" title="Ouvrir ${where} ${title}">${icon} ${title}</a>`;
    }).join('')}</div>`;
  }

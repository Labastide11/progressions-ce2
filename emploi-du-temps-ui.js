...
(() => {
    ...
    rentree1:{
      ...
      days:[
        ['Mardi 1er septembre 2026',[
          ...
          ['16h30–17h','Bilan — journée et rangement','Bilan collectif : une réussite, une question, une règle retenue ; rangement guidé.','Identifier ce qui a été appris et préparer son matériel.','common']
        ]],
  ...
  function p1FrenchWeekPlan(weekNumber){
    const seriesNames={
      1:'Charivari — série 1 « Le cheval et le fermier »',
      2:'Charivari — série 5 « Les métiers »',
      3:'Charivari — série 6 « Christophe et les nuages »',
      4:'Charivari — série 4 « La pluie »',
      5:'Réactivation des séries Charivari de P1'
    };
    const plans={
      1:['Lundi : dictée de mots + dictée flash 1 + vocabulaire','Mardi : dictée flash 2 (10 min) puis étude de la langue — DRAS','Jeudi : dictée flash 3 (10 min) puis DRAS + production d’écrit court','Vendredi : dictée bilan de phrases + correction raisonnée'],
      2:['Lundi : dictée de mots + dictée flash 1 + vocabulaire','Mardi : dictée flash 2 (10 min) puis étude de la langue — DRAS','Jeudi : dictée flash 3 (10 min) puis DRAS + production d’écrit court','Vendredi : dictée bilan de phrases + correction raisonnée'],
      3:['Lundi : dictée de mots + dictée flash 1 + vocabulaire','Mardi : dictée flash 2 (10 min) puis étude de la langue — DRAS','Jeudi : dictée flash 3 (10 min) puis DRAS + production d’écrit court','Vendredi : dictée bilan de phrases + correction raisonnée'],
      4:['Lundi : dictée de mots + dictée flash 1 + vocabulaire','Mardi : dictée flash 2 (10 min) puis bilan DRAS','Jeudi : dictée flash 3 (10 min) puis vocabulaire + production d’écrit court','Vendredi : dictée bilan de phrases + évaluation'],
      5:['Lundi : reprise des mots fragiles','Mardi : ateliers DRAS','Jeudi : vocabulaire et dictionnaire','Vendredi : seconde chance + production écrite']
    };
    const items=plans[weekNumber]||[];
    return `<div class="p1-french-sequence"><strong>📚 Fil rouge français de la semaine</strong><p><b>Support de dictée :</b> ${seriesNames[weekNumber]||''}</p><div>${items.map(x=>`<span>${x}</span>`).join('')}</div></div>`;
  }
  ...
  const p1DictationProgramming={
    1:{phase:'diagnostic',theme:'Rentrée — diagnostic très court',words:'Pas de banque à mémoriser.',priority:'Aucun mot prioritaire.',orthography:'Observer l’encodage des sons, la segmentation et les premières stratégies orthographiques.',orthographyWords:'Mots observés dans les productions spontanées des élèves ; pas de liste imposée.',grammar:'Phrase simple, majuscule, ponctuation et relecture.',grammarExamples:'Une phrase commence par une majuscule et se termine par un point.',reactivation:'Aucune : il s’agit d’un état des lieux de rentrée.',reactivationWords:'—',note:'Pas de dictée bilan classique : observation formative et correction collective raisonnée.'},
    2:{phase:'installation',theme:'Installer le rituel de dictée',words:'Premiers mots fréquents rencontrés en classe.',priority:'Sélection courte selon les observations de rentrée.',orthography:'Mémoriser progressivement des mots fréquents et stabiliser les correspondances sons/graphies.',orthographyWords:'À relever avec la classe dans les textes et activités de la semaine.',grammar:'Reconnaître une phrase ; phrase affirmative et phrase négative.',grammarExamples:'Ex. « Le chat dort. » / « Le chat ne dort pas. »',reactivation:'Réutiliser les mots rencontrés pendant la semaine 1.',reactivationWords:'Les mots réellement relevés lors du diagnostic de S1.',note:'Semaine d’installation : aucune liste de 8 mots n’est ajoutée artificiellement.'},
    3:{phase:'regular',corpusWeek:1,lessonId:'s1monday',theme:'Le cheval et le fermier',orthography:'Encoder les sons et mémoriser les mots fréquents ; observer ch dans cheval, chemin, chien et chaleur.',orthographyWords:'cheval, chemin, chien, chaleur',grammar:'Phrase correcte ; phrase affirmative et phrase négative.',grammarExamples:'Transformer une phrase du corpus en phrase négative puis revenir à l’affirmative.',reactivation:'Première banque structurée : pas d’anciens mots imposés.',reactivationWords:'—'},
    4:{phase:'regular',corpusWeek:2,lessonId:'s2monday',theme:'Les métiers',orthography:'Stabiliser l’orthographe lexicale des mots de métiers et des mots fréquents de la semaine.',orthographyWords:'Les 8 mots de la banque de S4 ; faire repérer les graphies difficiles dans chaque mot.',grammar:'Repérer le verbe conjugué et retrouver son infinitif.',grammarExamples:'Dans chaque phrase flash : entourer le verbe conjugué puis donner son infinitif.',reactivation:'Réemployer fermier et au moins un mot de la semaine précédente.',reactivationWords:'fermier + 1 mot choisi parmi cheval, voiture, chemin, chien, animal, chaleur, autour'},
    5:{phase:'regular',corpusWeek:3,lessonId:'s3monday',theme:'Christophe et les nuages',orthography:'Singulier/pluriel ; observer notamment le pluriel en -eaux dans chapeau/chapeaux.',orthographyWords:'chapeau → chapeaux ; repérer aussi les noms au singulier et au pluriel dans la banque et les phrases.',grammar:'Repérer le groupe sujet et le remplacer par un pronom.',grammarExamples:'Ex. remplacer « Christophe » ou un groupe nominal du corpus par il / ils.',reactivation:'Réemployer au moins deux mots issus des banques précédentes.',reactivationWords:'2 mots choisis parmi les banques S3 et S4, en privilégiant les mots encore fragiles.'},
    6:{phase:'regular',corpusWeek:4,lessonId:'s4monday',theme:'La pluie',orthography:'Consolider le pluriel et observer m devant m, b, p ainsi que son/sont dans le corpus.',orthographyWords:'Repérer dans la banque et les phrases les mots qui illustrent m devant m, b, p ; comparer son / sont dans leur phrase.',grammar:'Consolider verbe, infinitif, sujet et pronom.',grammarExamples:'À partir d’une phrase flash : trouver le sujet, le verbe conjugué, son infinitif puis remplacer le sujet par un pronom.',reactivation:'Réutiliser au moins deux mots déjà mémorisés, notamment autour des familles paysage/nuage.',reactivationWords:'2 mots déjà appris, choisis en priorité parmi ceux encore hésitants ; rapprocher paysage / nuage si présents dans les banques.'},
    7:{phase:'reactivation',corpusWeek:5,lessonId:'s5monday',theme:'Réactivation personnalisée de la période 1',orthography:'Reprendre les mots et régularités encore fragiles plutôt que lancer une nouvelle difficulté.',orthographyWords:'Reprendre les graphies réellement fragiles repérées dans les banques S3 à S6.',grammar:'Phrase, négation, verbe/infinitif, sujet/pronom, singulier/pluriel.',grammarExamples:'Choisir une phrase d’une dictée précédente et refaire l’analyse grammaticale complète.',reactivation:'Chaque élève choisit 3 à 5 mots encore fragiles parmi les banques précédentes.',reactivationWords:'3 à 5 mots personnalisés par élève parmi les banques S3 à S6.',note:'Aucune nouvelle liste : cette semaine constitue la boucle de consolidation de P1.'}
  };
  ...
  function renderP1Lesson(id,mode='teacher',step=0){
    ...
    const support=lesson.week===1?'Charivari — série 1 « Le cheval et le fermier »':lesson.week===2?'Charivari — série 5 « Les métiers »':lesson.week===3?'Charivari — série 6 « Christophe et les nuages »':lesson.week===4?'Charivari — série 4 « La pluie »':'Réactivation des dictées Charivari de P1';
  ...
  function renderRentreeMathLesson(id,mode='teacher',step=0){
    const [weekKey,...titleParts]=String(id||'').split('|'); const title=titleParts.join('|'); const l=rentreeMathLessons[title]; if(!l)return;
    const content=document.getElementById('timetableContent');
    if(mode==='student'){
      const s=l.slides[Math.max(0,Math.min(step,l.slides.length-1))];
      content.innerHTML=`<section class="lesson-view student-projector"><div class="detail-top"><div><span class="detail-zone">Projection élèves — semaines de rentrée</span><h2>${title}</h2></div><button class="detail-back" type="button" data-back-rentree-math="${weekKey}">← Retour à la semaine</button></div><div class="lesson-mode-tabs"><button data-open-rentree-math-mode="teacher" data-rentree-math-id="${id}">👩‍🏫 Déroulement enseignant</button><button class="is-active" data-open-rentree-math-mode="student" data-rentree-math-id="${id}">📽️ Projection élèves</button></div><article class="projector-slide ${s[0]}"><div class="slide-counter">${step+1} / ${l.slides.length}</div><h3>${s[1]}</h3><ul>${s[2].map(x=>`<li>${x}</li>`).join('')}</ul></article><div class="projector-nav"><button ${step===0?'disabled':''} data-rentree-math-step="${step-1}" data-rentree-math-id="${id}">← Précédente</button><button ${step===l.slides.length-1?'disabled':''} data-rentree-math-step="${step+1}" data-rentree-math-id="${id}">Suivante →</button></div></section>`;
    }else{
      content.innerHTML=`<section class="lesson-view"><div class="detail-top"><div><span class="detail-zone">Fiche enseignant — semaines de rentrée</span><h2>${title}</h2><p>${l.duration} · enseignement explicite · projection TBI</p></div><button class="detail-back" type="button" data-back-rentree-math="${weekKey}">← Retour à la semaine</button></div><div class="lesson-mode-tabs"><button class="is-active" data-open-rentree-math-mode="teacher" data-rentree-math-id="${id}">👩‍🏫 Déroulement enseignant</button><button data-open-rentree-math-mode="student" data-rentree-math-id="${id}">📽️ Projection élèves</button></div><div class="lesson-grid"><article class="lesson-card"><h3>🎯 Objectif explicite</h3><p><strong>Aujourd’hui, nous allons apprendre à ${l.objective}</strong></p><h4>Critères de réussite</h4><ul>${l.success.map(x=>`<li>${x}</li>`).join('')}</ul></article><article class="lesson-card"><h3>🧰 À préparer</h3><ul>${l.prep.map(x=>`<li>${x}</li>`).join('')}</ul></article><article class="lesson-card lesson-card--wide"><h3>Déroulement détaillé</h3><ol>${l.phases.map(x=>`<li><strong>${x[0]} — ${x[1]}</strong><br>${x[2]}</li>`).join('')}</ol></article><article class="lesson-card lesson-card--wide"><h3>Diaporama prévu</h3><p>${l.slides.length} écrans : objectif, modélisation ou oral, exercices, correction et bilan.</p></article></div></section>`;
    }
  }
  ...
  function renderP2Week(week){
    ...
    content.innerHTML=`<section class="detail-view"><div class="detail-top"><div><span class="detail-zone">Académie de Montpellier — zone C</span><h2>${data.title}</h2><p>${data.dates}</p></div><button class="detail-back" type="button" data-back-summary>← Retour à la vue synthétique</button></div>${detailWeekSelector('p2',data.key)}${data.holiday?`<div class="holiday-note">📅 ${data.holiday}</div>`:''}<div class="p1-focus"><div><strong>🎯 Intention de la semaine</strong><p>${data.focus}</p></div><span>${evalCount} temps de suivi répartis</span></div>${renderAnnualFrenchPlan(data.frenchPlan)}${renderAnnualEnglishPlan(data.englishPlan)}${data.days.map(([day,rows])=>`<section class="detail-day"><div class="detail-day-head"><h3>${day}</h3>${dayStatusToolbar()}</div><div class="detail-table-wrap"><table class="detail-table detail-table--p1"><thead><tr><th>Horaire</th><th>Domaine / activité</th><th>Séance proposée</th><th>Compétence reliée à Progressions CE2</th><th>Suivi / évaluation</th><th>Statut</th></tr></thead><tbody>${rows.map(r=>`<tr><td class="detail-time">${r[0]}</td><td><span class="detail-subject ${r[4]}">${r[1]}</span></td><td>${pedagogyMarkers('p2',data.key,day,r)}${r[2]}${annualMathLessonButton(r[6])}</td><td>${r[3]}</td><td><span class="${/Évaluation|Mini-test|Dictée/i.test(r[5])?'eval-badge':'follow-badge'}">${r[5]}</span></td><td>${statusSelect(statusKey(data.key,day,r[0]))}</td></tr>`).join('')}</tbody></table></div></section>`).join('')}</section>`;
    bindStatusControls(content);
  }
  ...
  function init(){
    ...
    content.addEventListener('click',e=>{
      ...
      if(rentreeMathBack){renderDetailedWeek(rentreeMathBack.dataset.backRentreeMath);content.scrollTop=0;return;}

...
(() => {
  ...
  function altered(day,key,mode,period){
    ...
    if(mode==='rentree'&&day==='jeudi') return [
      ...rows.slice(0,9),
      ['15h–15h45','Éducation musicale / arts','Classe entière : chant, rythme, création','arts'],
      ['15h45–16h','Récréation','','break'],
      ['16h–16h25','Anglais','Classe entière','english'],
      ['16h25–17h','Vocabulaire / production écrite','','french']
    ];
  ...
  // V36.32 — Cahier journal jeudi : créneaux 14h–15h restaurés et récréation 15h45–16h.

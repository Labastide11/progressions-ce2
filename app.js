(function(){
  ...
  const state={subject:'francais',period:'all',mode:'suivi',classView:'skill',selectedSkill:'',selectedStudent:''};
  ...
  function classCounts(skill){const counts={none:0,encours:0,acquis:0,renforcer:0};classRoster.forEach(name=>{const e=classEntry(name,skill.code);counts[e.level]=(counts[e.level]||0)+1;});return counts;}

(function(){
  ...
  function studentAvatarHtml(student,extraClass=''){const portrait=studentPortraitPath(student);const initials=String(student||'').trim().slice(0,2).toUpperCase();return '<span class="student-avatar '+extraClass+'"><img class="student-avatar__image" src="'+esc(portrait)+'" alt="Portrait de '+esc(student)+'"><span class="student-avatar__initials">'+esc(initials)+'</span></span>'; }

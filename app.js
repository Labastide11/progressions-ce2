(function(){
  ...
  document.querySelectorAll('[data-home-action]').forEach(btn=>btn.addEventListener('click',()=>{
    ...
    if(action==='hibou-link'){window.open('https://labastide11.github.io/Maitre-Hibou/','_blank','noopener');return;}
